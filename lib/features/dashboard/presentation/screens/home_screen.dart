...
import '../bloc/online_bloc.dart';
import '../bloc/online_event.dart';
import '../bloc/online_state.dart';
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<OnlineBloc>().add(const OnlineSummaryRequested());
                ...
                return BlocBuilder<OrderBloc, OrderState>(
                  builder: (context, orderState) {
                    return Scaffold(
                            ...
                            children: [
                              RefreshIndicator(
                                onRefresh: () async {
                                  context
                                      .read<OrderBloc>()
                                      .add(const OrderActiveRequested());
                                  context
                                      .read<OnlineBloc>()
                                      .add(const OnlineSummaryRequested());
                                },
                      ...
                      bottomNavigationBar:
                          const RiderBottomNav(isHistorySelected: false),
                    );
                  },
                );
              },
              ...
              onChanged: online.isLoading
                  ...
                  : (val) {
                      if (val) {
                        context
                            .read<OnlineBloc>()
                            .add(const OnlineGoOnlineRequested());
                      } else {
                        context
                            .read<OnlineBloc>()
                            .add(const OnlineGoOfflineRequested());
                      }
                    },
  ...
  Widget _buildJobCard(OrderState orderState) {
            ...
            children: [
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (value) => context
                    .read<OnlineBloc>()
                    .add(OnlineSummaryRequested(period: value)),
                itemBuilder: (_) => [
